...
public class TourChangeListener implements IElementChangedListener {
    ...
    void redoCU(ICompilationUnit cu, IProgressMonitor pm) {
        ...
        List<BusStop> newStops = Utilities.findJTourBusStops(pm, cu
                .getResource());
            ...
            try {
                ...
                if (delta.getElement().getElementType() == IJavaElement.JAVA_MODEL) {
                    ...
                    for (int i = 0; i < children.length; i++) {
                        ...
                        if (JTourBusPlugin.ALL_PROJECTS || fContentProvider.fProject.equals(children[i]
                                .getElement())) {
                    ...
                    if (JTourBusPlugin.ALL_PROJECTS || fContentProvider.fProject.equals(delta.getElement()
                            .getJavaProject()))
                        visit(null, delta);
                }
