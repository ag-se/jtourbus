...
/**
 * This adapter class provides generic drag-and-drop support for a viewer. <p>
 * Subclasses must implement the following methods: <ul> <li><code>validateDrop</code> -
 * identifies valid drop targets in viewer</li> <li><code>performDrop</code> -
 * carries out a drop into a viewer</li> </ul> The
 * <code>setFeedbackEnabled</code> method can be called to turn on and off
 * visual insertion feedback (on by default). </p>
 */
public abstract class ViewerDropAdapter extends DropTargetAdapter {
    ...
    /**
     * A flag that allows adapter users to turn auto scrolling and expanding on
     * or off. Default is <code>true</code>.
     */
     ...
     * user. <p> Typical insertion feedback is the horizontal insertion bars
     * that appear between adjacent items while dragging. </p>
     * 
     ...
     * 
     * @return the selected object, or <code>null</code> if either no object
     * or multiple objects are selected
     */
     ...
     * removed from DropTargetAdapter methods overridden by this class. Handles
     * any exception that occurs during callback, including rethrowing behavior.
     * <p> [Issue: Implementation prints stack trace and eats exception to avoid
     * crashing VA/J. Consider conditionalizing the implementation to do one
     * thing in VAJ and something more reasonable in other operating
     * environments. ] </p>
     * 
    ...
    /**
     * Performs any work associated with the drop. <p> Subclasses must implement
     * this method to provide drop behavior. </p>
     * 
     ...
     * <p> Typical insertion feedback is the horizontal insertion bars that
     * appear between adjacent items while dragging. </p>
     * 
     ...
     * dragging.
     * 
     * @param value <code>true</code> if scrolling and expanding is desired,
     ...
     * some aspect of the drop operation changes. <p> Subclasses must implement
     * this method to define which drops make sense. </p>
     * 
